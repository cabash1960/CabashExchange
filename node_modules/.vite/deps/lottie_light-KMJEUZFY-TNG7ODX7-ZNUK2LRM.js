...
`), i = {}, r, a = 0, h = 0; h < s.length; h += 1)
    ...
    Mt.prototype.setPathData = function(t, e) {
      ...
      for (var s = 0; s < e; )
        this.v[s] = Zt.newElement(), this.o[s] = Zt.newElement(), this.i[s] = Zt.newElement(), s += 1;
    ...
    var nt = function() {
      ...
      function e(r) {
        var a = r._length, h;
        for (h = 0; h < a; h += 1)
          Zt.release(r.v[h]), Zt.release(r.i[h]), Zt.release(r.o[h]), r.v[h] = null, r.i[h] = null, r.o[h] = null;
    ...
    var te = function() {
      ...
      function k(n, c, T, D, W, z, J, X, $, K, ut, Dt, mt, rt, gt, Z) {
        ...
        if (n === 1 && c === 0 && T === 0 && D === 0 && W === 0 && z === 1 && J === 0 && X === 0 && $ === 0 && K === 0 && ut === 1 && Dt === 0)
          return R[12] = R[12] * n + R[15] * mt, R[13] = R[13] * z + R[15] * rt, R[14] = R[14] * ut + R[15] * gt, R[15] *= Z, this._identityCalculated = false, this;
    ...
    ce.prototype.processPath = function(t, e, s, i) {
      ...
      Rs(a, t, 0, e, s, i, h);
      for (var o = 0; o < r; o += 1)
        h = Yi(a, m, e, s, i, -h), o === r - 1 && !t.c ? m = null : m = G.shapeSegment(t, (o + 1) % r), Rs(a, t, o + 1, e, s, i, h);
      return a;
    ...
    Y([yt], ge), ge.prototype.initModifierProperties = function(t, e) {
      ...
      var h, m, o, b = [];
      for (h = 0; h < a; h += 1)
        o = G.shapeSegment(t, h), b.push(Bs(o, e));
      if (!t.c)
        for (h = a - 1; h >= 0; h -= 1)
          o = G.shapeSegmentInverted(t, h), b.push(Bs(o, e));
      b = Ui(b);
      var _ = null, P = null;
      ...
      if (this.lettersChangedFlag = e, !(!this._mdf && !this._isFirstFrame && !e && (!this._hasMaskedPath || !this._pathData.m._mdf))) {
        ...
        for (_ = 0; _ < P; _ += 1) {
          if (a.reset(), mt = 1, f[_].n)
            ...
            for (t.strokeWidthAnim && (gt = t.sw || 0), t.strokeColorAnim && (t.sc ? rt = [t.sc[0], t.sc[1], t.sc[2]] : rt = [0, 0, 0]), t.fillColorAnim && t.fc && (Z = [t.fc[0], t.fc[1], t.fc[2]]), n = 0; n < c; n += 1)
            ...
            for (n = 0; n < c; n += 1) {
              ...
              if (t.fillColorAnim && t.fc) {
                if (d.fc.propType)
                  for (R = 0; R < 3; R += 1)
                    D.length ? Z[R] += (d.fc.v[R] - Z[R]) * D[0] : Z[R] += (d.fc.v[R] - Z[R]) * D;
...
@dotlottie/player-component/dist/lottie_light-KMJEUZFY-TNG7ODX7.mjs:
  ...
  *)
*/
//# sourceMappingURL=lottie_light-KMJEUZFY-TNG7ODX7-ZNUK2LRM.js.map
